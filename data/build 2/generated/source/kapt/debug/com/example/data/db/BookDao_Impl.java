...
public final class BookDao_Impl implements BookDao {
  ...
  public BookDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfBookEntity = new EntityInsertionAdapter<BookEntity>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, BookEntity value) {
        ...
        final String _tmp = __converters.fromAuthorsList(value.getAuthors());
        if (_tmp == null) {
          stmt.bindNull(3);
        } else {
  ...
  @Override
  public Object saveBook(final BookEntity book, final Continuation<? super Unit> continuation) {
  ...
  @Override
  public Object deleteBook(final BookEntity book, final Continuation<? super Unit> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        __db.beginTransaction();
